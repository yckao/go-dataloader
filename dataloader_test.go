...
func (c *ErrorCache[C, V]) Get(ctx context.Context, key C) (V, error) { if c.errOn == "Get" { return *new(V), c.err } else { return *new(V), nil } }
func (c *ErrorCache[C, V]) Set(ctx context.Context, key C, val V) error { if c.errOn == "Set" { return c.err } else { return nil } }
func (c *ErrorCache[C, V]) Delete(ctx context.Context, key C) error { if c.errOn == "Delete" { return c.err } else { return nil } }
func (c *ErrorCache[C, V]) Clear(ctx context.Context) error { if c.errOn == "Clear" { return c.err } else { return nil } }
